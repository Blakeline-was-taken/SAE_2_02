...
class ScenarioTest {
    ...
    public void constructeur() throws FileNotFoundException {
        ...
        mapTree.put(0, new Quete(new int[] {1, 1}, new int[][] {{3, 4}}, 4, 350, "vaincre Araignée lunaire"));
        mapTree.put(1, new Quete(new int[] {4, 3}, new int[][] {}, 2, 100, "explorer pic de Bhanborin"));
        mapTree.put(2, new Quete(new int[] {3, 1}, new int[][] {{1}, {}}, 1, 150, "dialoguer avec Kaela la chaman des esprits"));
        mapTree.put(3, new Quete(new int[] {0, 4}, new int[][] {{2}}, 3, 200, "explorer palais de Ahehona"));
        mapTree.put(4, new Quete(new int[] {3, 2}, new int[][] {{2}, {}}, 6, 100, "vaincre Loup Géant"));
